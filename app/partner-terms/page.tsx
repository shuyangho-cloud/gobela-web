...
export const metadata: Metadata = { title: 'Partner Terms & Conditions · GoBela' }
...
export default function PartnerTermsPage() {
  return (
    <div style={{ background: C.cream, minHeight: '100vh', fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
      ...
      <nav style={{
        ...
        <div style={{ maxWidth: 800, margin: '0 auto', display: 'flex', alignItems: 'center', height: 60, gap: 24 }}>
          ...
          <a href="/partners" style={{ fontSize: 13, color: C.coral, fontWeight: 600, textDecoration: 'none' }}>
      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '56px 24px 96px' }}>
        ...
        <div style={{ marginBottom: 48 }}>
          <p style={{ fontSize: 11, fontWeight: 600, color: C.coral, textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 10 }}>
            Legal
          </p>
          <h1 style={{ fontSize: 'clamp(28px,4vw,40px)', fontWeight: 700, color: C.navy, letterSpacing: '-0.02em', lineHeight: 1.15, marginBottom: 14 }}>
            Partner Terms & Conditions
          </h1>
          <p style={{ fontSize: 14, color: C.muted, lineHeight: 1.7 }}>
            Effective upon submission of your partner application via gobela.sg/partners.
          </p>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 32 }}>
          {[
            ...
            <div key={clause.n} style={{
              background: '#fff', border: `1px solid ${C.border}`, borderRadius: 16, padding: '28px 32px',
              display: 'flex', gap: 24,
            }}>
              <div style={{
              ...
              <div>
                <h2 style={{ fontSize: 16, fontWeight: 700, color: C.navy, marginBottom: 8 }}>
                  {clause.title}
                </h2>
        ...
        {/* Footer CTA */}
        <div style={{
          marginTop: 48, padding: '32px', background: '#fff',
          ...
          <p style={{ fontSize: 14, color: C.muted, marginBottom: 20, lineHeight: 1.7 }}>
            ...
            <a href="mailto:hello@gobela.sg" style={{ color: C.navy, fontWeight: 600, textDecoration: 'none' }}>
              hello@gobela.sg
            </a>
          </p>
