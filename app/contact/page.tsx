      ...
      <main className="pt-16">
        <div className="max-w-2xl mx-auto px-5 py-20">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-extrabold text-[#1A2C4E] mb-4">Talk to us</h1>
            <p className="text-gray-500 text-lg">
              Partner with us, share feedback, or just say hello. We read every message.
            </p>
          </div>
          ...
          {status === "sent" ? (
            <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-12 text-center">
              ...
              <h2 className="text-2xl font-extrabold text-[#1A2C4E] mb-2">Message sent!</h2>
            ...
            >
              <div>
                <label className="block text-sm font-semibold text-[#1A2C4E] mb-2">Name</label>
                <input
                  type="text"
                  name="name"
                  required
              ...
              <div>
                <label className="block text-sm font-semibold text-[#1A2C4E] mb-2">Email</label>
                <input
                  type="email"
                  name="email"
                  required
              ...
              <div>
                <label className="block text-sm font-semibold text-[#1A2C4E] mb-2">Subject</label>
                <select
                  name="subject"
                  aria-label="Subject"
                ...
                >
                  <option value="Partnership">Partnership / Become a partner</option>
              ...
              <div>
                <label className="block text-sm font-semibold text-[#1A2C4E] mb-2">Message</label>
                <textarea
                  name="message"
                  required
                  rows={5}
              ...
              {status === "error" && (
                <p className="text-red-500 text-sm text-center">
                  Something went wrong. Please try again or email us directly at hello@gobela.sg
                </p>
              )}
