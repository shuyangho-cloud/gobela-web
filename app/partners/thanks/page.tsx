    ...
    <>
      ...
      <main className="pt-16 min-h-screen flex items-center justify-center bg-[#F8F9FA]">
        <div className="text-center max-w-md mx-auto px-5 py-20">
          ...
          <h1 className="text-3xl font-extrabold text-[#1A2C4E] mb-4">Application received!</h1>
          <p className="text-gray-500 mb-8">
            Thank you for applying to become a GoBela partner. Our team will review your application
            and reach out within 3 business days.
          </p>
          <Link
            href="/"
